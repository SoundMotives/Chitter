...
def test_gets_all_posts(db_connection):
    with freeze_time("2022-02-01 12:00:00"):
        ...
        assert posts == [
            Post(1, 'Just posting something for lols', '2024-02-02 00:00:00', 1),
            Post(2, 'This is my first post!','2024-02-02 00:00:02', 2),
        ]
...
def test_find_for_id_1(db_connection):
    ...
    assert post == Post(1, 'Just posting something for lols', '2024-02-02 00:00:00', 1)

def test_find_for_id_2(db_connection):
    db_connection.seed("seeds/seeds_users.sql")
    repository = PostRepository(db_connection)
    post = repository.find(2)
    assert post == Post(2, 'This is my first post!','2024-02-02 00:00:02', 2)
